                    ...
                    <div class="row g-0">
                        <div class="col-md-12 text-center">
                            <div class="card-body">
                                ...
                                <p class="mission-text">Our mission is to create a Student Information System that is intuitive, user-friendly, 
                                    and designed to simplify academic and administrative tasks, 
                                    making every interaction seamless and supportive for students.</p>
                                <p><b><u>Our Vission</u></b></p>
                                <p class="mission-text">Our vision is to enhance the student experience by developing a 
                                    Student Information System that is empathetic, personalized, and easy to use, 
                                    empowering users to feel connected, supported, and in control of their educational journey.</p>
                            </div>
                        </div>
                    </div>
                </div>
